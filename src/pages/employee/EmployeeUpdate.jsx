                ...
                <div className="grid sm:grid-cols-2 grid-cols-1 w-full">
                   ...
                   text-blue-gray-700 
                    ...
                    >
                      ...
                      {dpms &&
                        dpms.length > 0 &&
                        dpms.map(
                          ({ department_Id, department_Name }, index) => (
                  ...
                  <div className="flex flex-col xl:w-full p-1">
                   ...
                   text-blue-gray-700 
                     ...
                     border-[1px]
                     focus:border-[2px]
                     ${touched && touched.pst_id && errors && errors.pst_id ? "!border-red-500 focus:border-red-500" : "border-blue-gray-200 focus:border-blue-gray-900"}                                             
                    hover:border-blue-gray-400  
                      appearance-none cursor-pointer
                      `}
                      value={values.pst_id}
                  ...
                  <div className="flex flex-col xl:w-full p-1">
                   ...
                   text-blue-gray-700 
                     ...
                     border-[1px]
                     focus:border-[2px]
                     ${touched && touched.role_id && errors && errors.role_id ? "!border-red-500 focus:border-red-500" : "border-blue-gray-200 focus:border-blue-gray-900"}                                             
                    hover:border-blue-gray-400  
                      appearance-none cursor-pointer
                      `}
