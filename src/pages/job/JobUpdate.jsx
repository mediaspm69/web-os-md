...
import OSEditor from 'react-simple-wysiwyg';
...
export function JobUpdate() {
  ...
  const { loader, setLoader,dpms, dataEmp } = useContext(MyContext);
          ...
          <div className="w-full mb-2">
             ...
             <OSEditor                  
                    ...
                    onChange={(e) =>{
                      ...
                      setFieldValue('job_Detail',e.target.value)
                    }}
              ...
              {/* {values.job_Detail && (
                  <div>
                    <div
                      dangerouslySetInnerHTML={{ __html: values.job_Detail }}
                    />
                  </div>
                )} */}
            </div>
                ...
                <Input
                  ...
                  icon={
                    <InformationCircleIcon
                      ...
                      color={values.job_file ? "blue" : "gray"}
                      className="w-8 "
                    />
                  }
                />
